...
if (! file.exists("artwork.csv"))
    download.file("https://raw.githubusercontent.com/Sparkypaysrent/School_Projects/main/STAT4580/artwork.csv", "artwork.csv")


# cleaned up version of data, so world map works

if (! file.exists("artist_data.csv"))
    download.file("https://https://raw.githubusercontent.com/Sparkypaysrent/School_Projects/main/STAT4580/artist_data.csv", "artist_data.csv")
...
_https://github.com/rfordatascience/tidytuesday/blob/master/data/2021/2021-01-12/readme.md_
